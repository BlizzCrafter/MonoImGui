...
namespace MonoImGui
{
    ...
    public class ImGuiRenderer
    {
        ...
        private void SetupTheme(Game game)
        {
            ...
            style.Colors[(int)ImGuiCol.WindowBg] = new Num.Vector4(0.20f, 0.20f, 0.20f, 1.00f);
            style.Colors[(int)ImGuiCol.ChildBg] = new Num.Vector4(0.13f, 0.13f, 0.13f, 1.00f);
            style.Colors[(int)ImGuiCol.PopupBg] = new Num.Vector4(0.18f, 0.18f, 0.18f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.ScrollbarGrabActive] = new Num.Vector4(0.90f, 0.70f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.CheckMark] = new Num.Vector4(0.90f, 0.70f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.SliderGrab] = new Num.Vector4(0.90f, 0.70f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.SliderGrabActive] = new Num.Vector4(1.00f, 0.86f, 0.38f, 1.00f);
            style.Colors[(int)ImGuiCol.Button] = new Num.Vector4(0.82f, 0.64f, 0.00f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.SeparatorActive] = new Num.Vector4(0.90f, 0.70f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.ResizeGrip] = new Num.Vector4(0.63f, 0.49f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.ResizeGripHovered] = new Num.Vector4(1.00f, 0.86f, 0.37f, 1.00f);
            style.Colors[(int)ImGuiCol.ResizeGripActive] = new Num.Vector4(0.90f, 0.70f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.Tab] = new Num.Vector4(0.63f, 0.16f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.TabHovered] = new Num.Vector4(0.99f, 0.33f, 0.11f, 1.00f);
            style.Colors[(int)ImGuiCol.TabActive] = new Num.Vector4(0.90f, 0.24f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.TabUnfocused] = new Num.Vector4(0.16f, 0.09f, 0.11f, 0.97f);
            style.Colors[(int)ImGuiCol.TabUnfocusedActive] = new Num.Vector4(0.36f, 0.20f, 0.25f, 0.97f);
            style.Colors[(int)ImGuiCol.DockingPreview] = new Num.Vector4(0.62f, 0.49f, 0.01f, 1.00f);
            style.Colors[(int)ImGuiCol.DockingEmptyBg] = new Num.Vector4(0.30f, 0.30f, 0.30f, 1.00f);
            style.Colors[(int)ImGuiCol.PlotLines] = new Num.Vector4(0.61f, 0.61f, 0.61f, 1.00f);
            style.Colors[(int)ImGuiCol.PlotLinesHovered] = new Num.Vector4(0.91f, 0.24f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.PlotHistogram] = new Num.Vector4(0.77f, 0.00f, 0.90f, 1.00f);
            style.Colors[(int)ImGuiCol.PlotHistogramHovered] = new Num.Vector4(0.88f, 0.19f, 0.99f, 1.00f);
            style.Colors[(int)ImGuiCol.TableHeaderBg] = new Num.Vector4(0.62f, 0.49f, 0.01f, 1.00f);
            style.Colors[(int)ImGuiCol.TableBorderStrong] = new Num.Vector4(0.31f, 0.31f, 0.35f, 1.00f);
            style.Colors[(int)ImGuiCol.TableBorderLight] = new Num.Vector4(0.41f, 0.41f, 0.44f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.TextSelectedBg] = new Num.Vector4(0.63f, 0.49f, 0.01f, 1.00f);
            style.Colors[(int)ImGuiCol.DragDropTarget] = new Num.Vector4(0.88f, 0.19f, 0.99f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.ModalWindowDimBg] = new Num.Vector4(0.20f, 0.20f, 0.20f, 0.67f);
        }
        ...
        private unsafe void CreateFont(string fontFile, float fontSize, byte mergeMode, ushort[] charRange)
        {
            ...
            (*nativeConfig).GlyphExtraSpacing = new Num.Vector2(0, 0);
